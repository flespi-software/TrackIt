<template>
  <q-modal @hide="$emit('close')" ref="modal" :content-css="{maxWidth: '100vw', maxHeight: '100vh', width: $q.platform.is.mobile ? '100vw' : '500px', height: $q.platform.is.mobile ? '100vh' : '400px'}" :content-classes="{'bg-dark': inverted !== undefined}">
    <q-modal-layout>
